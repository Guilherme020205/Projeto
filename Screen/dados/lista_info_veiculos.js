const inscricao_veiculos = ['1', '2', '3', '4', '5', '6']
const marcas_veiculos = ['FERRARI', 'BMW', 'NISSAN', 'FERRARI', 'BMW', 'NISSAN']
const modelos_veiculos = ['FERRARI ROMA', 'BMW X4', 'NISSAN KICKS', 'FERRARI ROMA', 'BMW X4', 'NISSAN KICKS']
const precos_veiculos = ['3.150.000', '559.900', '107.900', '3.150.000', '559.900', '107.900']
const anos_veiculos = ['2022/2022', '2019/2020', '2023/2024', '2022/2022', '2019/2020', '2023/2024']
const km_veiculos = ['430', '33.000', '0', '430', '33.000', '0']
const cor_veiculos = ['Vermelho', 'Preto', 'cinza', 'Vermelho', 'Preto', 'cinza']
const combustivel_veiculos = ['Gasolina', 'Gasolina', 'Gasolina e álcool', 'Gasolina', 'Gasolina', 'Gasolina e álcool']
const marcha_veiculos = ['Automatizada DCT', 'Automática', 'Automática', 'Automatizada DCT', 'Automática', 'Automática']
const carroceria_veiculos = ['Cupê', 'Utilitário esportivo', 'Utilitário esportivo', 'Cupê', 'Utilitário esportivo', 'Utilitário esportivo']
